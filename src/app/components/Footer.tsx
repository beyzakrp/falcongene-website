      ...
      <div className="mx-auto max-w-6xl px-6 py-12 grid gap-10 md:grid-cols-3">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              ...
              <li><Link href="/kvkk" className="hover:underline">KVKK Aydınlatma Metni</Link></li>
                            <li><Link href="/iletisim" className="hover:underline">Gizlilik Politikası</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-3 flex gap-3">
            {[
              { href: "/iletisim", label: "Twitter", path: "M22.46 6c-.77.35-1.6.58-2.46.69a4.27 4.27 0 0 0-7.27 3.89A12.1 12.1 0 0 1 3.15 4.6a4.27 4.27 0 0 0 1.32 5.7 4.22 4.22 0 0 1-1.93-.53v.05a4.27 4.27 0 0 0 3.42 4.18 4.3 4.3 0 0 1-1.92.07 4.27 4.27 0 0 0 3.98 2.96A8.57 8.57 0 0 1 2 19.54a12.08 12.08 0 0 0 6.56 1.92c7.88 0 12.2-6.53 12.2-12.2 0-.19 0-.39-.01-.58A8.7 8.7 0 0 0 24 5.56a8.6 8.6 0 0 1-2.54.7Z" },
              { href: "/iletisim", label: "LinkedIn", path: "M4.98 3.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5ZM3 8.98h4v12H3v-12Zm7 0h3.82v1.64h.05a4.19 4.19 0 0 1 3.76-2.07c4.03 0 4.77 2.65 4.77 6.1v6.33h-4v-5.62c0-1.34-.03-3.07-1.87-3.07-1.87 0-2.16 1.46-2.16 2.97v5.72h-4v-12Z" },
              { href: "/iletisim", label: "Instagram", path: "M7 2h10a5 5 0 0 1 5 5v10a5 5 0 0 1-5 5H7a5 5 0 0 1-5-5V7a5 5 0 0 1 5-5Zm5 5a5 5 0 1 0 0 10 5 5 0 0 0 0-10Zm6.5-.25a1.25 1.25 0 1 0 0-2.5 1.25 1.25 0 0 0 0 2.5Z" },
            ].map((s) => (
